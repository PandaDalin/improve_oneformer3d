...
custom_imports = dict(imports=['oneformer3d', 'oneformer3d.focal_loss'])
    ...
    dict(
        ...
        transforms=[
            dict(
                type='NormalizePointsColor_',
                color_mean=[127.5, 127.5, 127.5])]),
    dict(type='Pack3DDetInputs_', keys=['points', 'pts_semantic_mask', 'pts_instance_mask'])
]
